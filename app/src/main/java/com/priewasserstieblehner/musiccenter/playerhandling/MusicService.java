...
public class MusicService extends Service implements
    ...
    public void playMedia(){
        ...
        if(oldCurr != null && currMedia != null  && oldCurr.getType() != currMedia.getType()) {
            player.pause();
            videoView.pause();
            if(yTState != YouTubeState.STOPPED) {
                yTState = YouTubeState.STOPPED;
    ...
    public int getPosn(){
        switch(currMedia.getType()) {
            ...
            case YOUTUBE: return yTState != YouTubeState.STOPPED ? youTubePlayer.getCurrentTimeMillis() : 0;
            default: return 0;
        }
    }
    ...
    public int getDur(){
        ...
        switch(currMedia.getType()) {
            ...
            case YOUTUBE: res = yTState != YouTubeState.STOPPED ? youTubePlayer.getDurationMillis() : 0; break;
        }
        return res;
    }
    ...
    public void seek(int posn){
        ...
        switch(currMedia.getType()) {
            ...
            case YOUTUBE:
                if(yTState != YouTubeState.STOPPED) youTubePlayer.seekToMillis(posn);
                break;
        }
    }
